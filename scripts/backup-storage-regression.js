...
assertIncludes(backupSource, "import extract from '@electron-internal/extract-zip'", 'backup import should use Electron\'s path-safe zip archive extraction fork')
...
assertIncludes(backupSource, 'await extract(archivePath, { dir: targetDir })', 'backup import should delegate path, symlink, and zip-bomb containment to the hardened extractor')
