...
assertIncludes(libraryCache, "const CACHE_VERSION = 'library-sidebar-v4-vectorized-smart-view'", 'library cache version should change when smart-view count semantics change')
...
assertIncludes(libraryView, 'embeddingReady', 'library view should expose 已向量化 smart filter')
