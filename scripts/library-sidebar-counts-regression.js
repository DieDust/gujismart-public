...
assertIncludes(libraryCache, 'scheduleLibraryStateCacheRefresh(200)', 'old or dirty library cache should be refreshed automatically')
...
assertIncludes(libraryCache, 'if (!row?.cache_json) return emptyCache(true)', 'missing sidebar cache should not run full statistics during ordinary reads')
