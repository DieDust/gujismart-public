...
assertIncludes(libraryCache, "const CACHE_VERSION = 'library-sidebar-v5-embedding-smart-views'", 'library cache version should change when smart-view count semantics change')
