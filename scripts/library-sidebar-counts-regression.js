...
const ocrLibraryFilters = read('src/main/ocr-library-filters.ts')
...
assertIncludes(libraryCache, "const CACHE_VERSION = 'library-sidebar-v7-project-scoped'", 'library cache version should change when smart-view count semantics change')
...
assertIncludes(types, "| 'ocrNeedsRepair'", 'LibrarySmartViewCountKey should include OCR repair documents')
...
assertIncludes(libraryView, "countKey: 'ocrNeedsRepair'", 'smart sidebar catalog should include OCR repair')
assertIncludes(libraryView, "label: 'OCR 待修复'", 'smart sidebar should label the OCR repair category')
