...
最新安装包见 [GitHub Releases](https://github.com/DieDust/gujismart-public/releases)（当前 **v1.2.25**）。完整图文教程见 [docs/文献管理-图文使用教程.md](docs/文献管理-图文使用教程.md)。
...
- **文献项目**：启动时只装载一个项目；旧库自动归入默认项目，文献可在项目间移动或复制，OCR、AI、向量等服务配置保持全局共享。
