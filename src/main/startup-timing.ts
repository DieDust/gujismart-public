...
const PHASE_LABELS: Record<string, string> = {
  ...
  'startup-recovery.interrupted-imports.collect': '收集中断导入候选',
  'startup-recovery.interrupted-imports.light': '轻量修复中断导入（仅数据库）',
  'startup-recovery.interrupted-imports.full': '完整修复中断导入',
